...
<body>
    ...
    <table border="0" style="margin-top: -5%; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;" class="kop" width="100%">
        <tr>
            ...
            <td>
                ...
                @elseif($data_penugasan->User->kontrak_kerja=='SPS')
                <h4 style="text-align: center; font-size: 20pt;">PT&nbsp;SURYA&nbsp;PANGAN&nbsp;SEMESTA1</h4>
                @elseif($data_penugasan->User->kontrak_kerja=='SIP')
    ...
    <h6 class="text-center" style="margin-top: -3%;"> FORMULIR<br>PERMINTAAN PERJALANAN DINAS hgih</h6>
    ...
    <div class="row">
        ...
        <div class="col-6">
            <table style="margin-top: 0%; font-size: 10pt; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">
                <thead>
                    <th colspan="2" style="text-align: center;">Transportasi:</th>
                    <th colspan="2" style="text-align: center;">Kelas:</th>
                    <th style="text-align: center;">Budget/Hotel:</th>
                </thead>
                <tbody>
                    <tr>
                        <td>
        ...
        <tbody>
            <tr style="font-weight: bold;">
                <td style="text-align: center;">
                    <img src="{{ url('https://karyawan.sumberpangan.store/laravel/public/signature/'.$data_penugasan->ttd_user.'.png') }}" width="100%" alt="">
                    <p>{{$data_penugasan->User->name}}<br>(Karyawan)</p>
                </td>
                <td style="text-align: center;">
                    <img src="{{ url('https://karyawan.sumberpangan.store/laravel/public/signature/'.$data_penugasan->ttd_atasan.'.png') }}" width="100%" alt="">
                    <p style="margin-bottom: -10px;">{{$data_penugasan->approve_atasan}}<br>(Atasan 1)</p>
                </td>
                <td style="text-align: center;">
                    <img src="{{ url('https://karyawan.sumberpangan.store/laravel/public/signature/'.$data_penugasan->ttd_atasan2.'.png') }}" width="100%" alt="">

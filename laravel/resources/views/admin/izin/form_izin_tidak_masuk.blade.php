...
<body>
    <div style="float: right; margin-top: -30px; margin-right: -10px; width:250px; height: auto;border: 1px solid black; box-sizing: border-box;">
        <h5 style="text-align: right; font-size: 12pt; ">
    ...
    <table border="0" style="margin-top: 3px;" class="kop" width="100%">
        <tr>
            ...
            <td style="width:50%; font-size: 12pt;">
                @if($data_izin->User->kontrak_kerja=='SP')
                <h4 style="text-align: center; font-size:17pt;">CV.&nbsp;SUMBER&nbsp;PANGAN</h4>
                @elseif($data_izin->User->kontrak_kerja=='SPS')
                <h4 style="text-align: center; font-size:17pt;">PT.&nbsp;SURYA&nbsp;PANGAN&nbsp;SEMESTA</h4>
                @elseif($data_izin->User->kontrak_kerja=='SIP')
                <h4 style="text-align: center; font-size:17pt;">CV. SURYA&nbsp;INTI&nbsp;PANGAN</h4>
                @endif
            </td>
    ...
    <h6 class="text-center" style="margin-top: -3%;"> FORMULIR PERMOHONAN<br>IJIN TIDAK MASUK</h6>
    <table style="margin-top: 2%; font-size: 10pt;" width="100%">
        <tbody>
            <tr>
                <th>NIK</th>
                <td>:&nbsp;{{$data_izin->User->nomor_identitas_karyawan}}</td>
                <th>Departemen</th>
    ...
    <table border="1" style="margin-top: 1%; font-size: 10pt;" width="100%">
    ...
    <div style="float: left; margin-top: 15px; width:100%; height: 100px;border: 1px solid #E6E6FA; box-sizing: border-box; border-radius: 7px;">
        <h5 style="text-align: left; font-size: 10pt;  padding-left: 3px;">
            Alasan Tidak Masuk : <br>
            {{$data_izin->keterangan_izin}}&nbsp;
        </h5>
    </div>
    <table style="margin-top: 20%; font-size: 10pt; " width="100%">
        <thead style="background-color:#E6E6FA;">
            <th colspan="7" style="text-align: center;">SERAH TERIMA TUGAS SELAMA TIDAK MASUK</th>
        </thead>
        <tbody>
            <tr>
                <th>Kepada</th>
    ...
    <div style="float: left; margin-top: 5%; margin-bottom: 10%; width:100%; height: 100px;border: 1px solid #E6E6FA; box-sizing: border-box; border-radius: 7px;">
        <h5 style="text-align: left; padding-left: 3px; font-size: 10pt;">
            Catatan Selama Meninggalkan Lokasi Kerja : <br>
            {{$data_izin->catatan_backup}}&nbsp;
        </h5>
    </div>
    <h5></h5>
    <table class="table table-bordered" style="margin-top:25%; font-size: 10pt;" width="100%">
        <thead>
            <tr style="text-align: center;">
                <th>Pemohon</th>

...
video.addEventListener('play', () => {
    ...
    Swal.fire({
        ...
        // background: 'transparent',
        position: 'bottom',
        html: '<div style="width:100%;" class="me-2 mb-2 d-flex align-items-center text-center"><span class="spinner-border me-3 spinner-border-sm text-primary" role="status" aria-hidden="true"></span>Letakkan&nbsp;Wajah&nbsp;Didepan&nbsp;Kamera..</div>',
        showCancelButton: false,
        showConfirmButton: false,

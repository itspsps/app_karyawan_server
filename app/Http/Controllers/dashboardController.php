...
class dashboardController extends Controller
{
    public function index()
    {
        ...
        return view('admin.dashboard.index', [
            ...
            "karyawan_laki" => Karyawan::where('gender', "1")->where('status_aktif', 'AKTIF')->where('kontrak_kerja', $holding)->count(),
            "karyawan_perempuan" => Karyawan::where('gender', "2")->where('status_aktif', 'AKTIF')->where('kontrak_kerja', $holding)->count(),

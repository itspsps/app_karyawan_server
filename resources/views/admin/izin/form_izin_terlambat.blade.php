    ...
    <table border="1" style="margin-top: 2%; font-size: 10pt;" width="100%">
        ...
        <tbody>
            <tr style="text-align: center;">
                <td>@if($data_izin->jam_masuk_kerja=='') - @else{{\Carbon\Carbon::parse($data_izin->jam_masuk_kerja)->format('H:i')}} WIB @endif</td>
                <td>@if($data_izin->jam=='') - @else{{\Carbon\Carbon::parse($data_izin->jam)->format('H:i')}} WIB @endif</td>
        ...
        <tbody>
            <tr style="font-weight: bold;font-size: 10pt;">
                <td style="text-align: center;">
                    <img src="{{ url('http://127.0.0.1/public/signature/'.$data_izin->ttd_pengajuan.'.png') }}" width="100%" alt="">
                    <p>({{$data_izin->fullname}})</p>
                </td>
                <td style="text-align: center;">
                    <img src="{{ url('http://127.0.0.1/public/signature/'.$data_izin->ttd_atasan.'.png') }}" width="100%" alt="">

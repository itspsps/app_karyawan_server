                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center justify-content-between">
                            <h5 class="card-title m-0 me-2"><a
                                    href="@if (Auth::user()->is_admin == 'hrd') {{ url('hrd/jabatan/' . $holding->holding_code) }}@else{{ url('jabatan/' . $holding->holding_code) }} @endif"><i
                                        class="mdi mdi-arrow-left-bold"></i></a>&nbsp;DAFTAR JABATAN</h5>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                        ...
                        <hr class="my-5">
                        <button type="button" id="btn_add_jabatan" class="btn btn-sm btn-primary waves-effect waves-light"
                            data-bs-toggle="modal" data-bs-target="#modal_tambah_jabatan"><i
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                <div class=" modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="col-lg-12">
                                            <table class="table" id="table_karyawan_jabatan"
                        ...
                        <div class="modal fade" id="modal_bawahan_jabatan" data-bs-backdrop="static" tabindex="-1">
                            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                <div class=" modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="col-lg-12">
                                            <table class="table" id="table_bawahan_jabatan"
                                                style="width: 100%; font-size: small;">
                                                <thead class="table-primary">
                                                    <tr>
                                                        <th>No.</th>
                        ...
                        <div class="modal fade" id="modal_tambah_jabatan" data-bs-backdrop="static" tabindex="-1">
                            <div class="modal-dialog modal-dialog-scrollable">
                                <form id="form_add_jabatan" method="post"
                                    action="@if (Auth::user()->is_admin == 'hrd') {{ url('/hrd/jabatan/insert/' . $holding->holding_code) }}@else{{ url('/jabatan/insert/' . $holding->holding_code) }} @endif"
                                    ...
                                    <div class="modal-body">
                                        <div class="row g-2">
                                            <div class="col mb-2">
                                                <input type="hidden" id="nama_departemen" name="nama_departemen"
                                                    value="{{ $divisi->Departemen->id }}">
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" name="nama_divisi"
                                                        id="nama_divisi" value="{{ $divisi->nama_divisi }}" readonly>
                                            ...
                                            <div class="col mb-2">
                                                <div class="form-floating form-floating-outline">
                                                    <select class="form-control @error('nama_bagian') is-invalid @enderror"
                                                        id="nama_bagian" name="nama_bagian" autofocus
                                            ...
                                            <div class="form-floating form-floating-outline">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="lintas_departemen" name="lintas_departemen">
                                                    <label class="form-check-label" for="lintas_departemen">Lintas
                                                        Departemen</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col mb-2">
                                            <div class="form-floating form-floating-outline">
                                                ...
                                                <select
                                                    class="form-control @error('nama_jabatan_atasan') is-invalid @enderror"
                                                    id="nama_jabatan_atasan" name="nama_jabatan_atasan" autofocus
                                                    value="{{ old('nama_jabatan_atasan') }}">
                                                    <option value=""> Pilih Jabatan Atasan</option>
                                                </select>
                                                <label for="nama_jabatan_atasan" class="float-left">Nama Jabatan
                                                    Atasan</label>
                                            </div>
                                        ...
                                        <input type="hidden"
                                            class="form-control @error('level_jabatan') is-invalid @enderror"
                                            id="level_jabatan" name="level_jabatan" readonly
                        ...
                        <div class="modal fade" id="modal_edit_jabatan" data-bs-backdrop="static" tabindex="-1">
                            <div class="modal-dialog modal-dialog-scrollable">
                                <form method="post"
                                    action="@if (Auth::user()->is_admin == 'hrd') {{ url('/hrd/jabatan/update/' . $holding->holding_code) }}@else{{ url('/jabatan/update/' . $holding->holding_code) }} @endif"
                                    class="modal-content" enctype="multipart/form-data">
                                    @csrf
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <input type="hidden" id="nama_departemen_update" name="nama_departemen_update"
                                            value="">
                                        <div class="row g-2">
                                            <div class="col mb-2">
                                                <div class="form-floating form-floating-outline">
                                                    <input
                                                        ...
                                                        readonly id="nama_divisi_update" name="nama_divisi_update"
                                                ...
                                                <div class="form-floating form-floating-outline">
                                                    <select
                                                        ...
                                                        @foreach ($data_bagian as $s)
                                                            <option value="{{ $s->id }}">{{ $s->nama_bagian }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="row g-2">
                                            ...
                                            <div class="col mb-2">
                                                ...
                                                <div class="form-floating form-floating-outline">
                                                    ...
                                                    <label for="nama_jabatan_update" class="float-left">Nama
                                                        Jabatan</label>
                                                </div>
                                        ...
                                        <div class="col mb-2">
                                            <div class="form-floating form-floating-outline">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="lintas_departemen_update" name="lintas_departemen_update">
                                                    <label class="form-check-label" for="lintas_departemen_update">Lintas
                                                        Departemen</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col mb-2">
                                            <div class="form-floating form-floating-outline">
                                                ...
                                                <select
                                                    class="form-control @error('nama_jabatan_atasan_update') is-invalid @enderror"
                                                    id="nama_jabatan_atasan_update" name="nama_jabatan_atasan_update"
                                                    autofocus value="{{ old('nama_jabatan_atasan_update') }}">
                                                    <option value=""> Pilih Jabatan Atasan</option>
                                                </select>
                                                <label for="nama_jabatan_atasan_update" class="float-left">Nama Jabatan
                                                    Atasan</label>
                                            </div>
                                    ...
                                    <input type="hidden"
                                        class="form-control @error('level_jabatan_update') is-invalid @enderror"
                                        id="level_jabatan_update" name="level_jabatan_update" readonly
                                        value="{{ old('level_jabatan_update') }}">
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">
                                            Close
                                        </button>
...
@section('js')
    ...
    <script>
        ...
        var table = $('#table_jabatan').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "@if (Auth::user()->is_admin == 'hrd'){{ url('hrd/jabatan-datatable') }}@else{{ url('jabatan-datatable') }}@endif" +
                    '/' + id + '/' + holding,
            },
            columns: [{
                    data: "id",
    ...
    <script>
        $('#nama_jabatan').on('change', function() {
            ...
            let holding = '{{ $holding }}';
            let url =
                "@if (Auth::user()->is_admin == 'hrd'){{ url('hrd/atasan/get_jabatan') }}@else{{ url('atasan/get_jabatan') }}@endif" +
                "/" + holding;
            console.log(divisi);
            // console.log(url);
            $.ajax({
        ...
        $('#nama_jabatan_update').on('change', function() {
            ...
            let holding = '{{ $holding }}';
            let url =
                "@if (Auth::user()->is_admin == 'hrd'){{ url('hrd/atasan/edit/get_jabatan') }}@else{{ url('atasan/edit/get_jabatan') }}@endif" +
                "/" + holding;
            console.log(divisi);
            // console.log(url);
            $.ajax({
        ...
        $(document).on('click', '#btn_lihat_bawahan', function() {
            ...
            let holding = $(this).data("holding");
            let url =
                "@if (Auth::user()->is_admin == 'hrd'){{ url('hrd/bawahanjabatan-datatable') }}@else{{ url('bawahanjabatan-datatable') }}@endif" +
                '/' + id + '/' + holding;
            // console.log(url);
        ...
        $(document).on('click', '#btn_delete_jabatan', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "@if (Auth::user()->is_admin == 'hrd'){{ url('/hrd/jabatan/delete/') }}@else{{ url('/jabatan/delete/') }}@endif" +
                            '/' + id + '/' + holding,
                        type: "GET",
                        data: {
                            holding: holding,

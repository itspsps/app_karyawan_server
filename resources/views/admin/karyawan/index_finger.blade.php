            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        <h5 class="card-title m-0 me-2">DATA USER FINGER</h5>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <hr class="my-5">
                    <table class="table" id="table_users_finger" style="width: 100%; font-size: smaller;">
...
<script>
    ...
    console.log(holding);
    var table = $('#table_users_finger').DataTable({
        pageLength: 50,
        "scrollY": true,
        "scrollX": true,
        processing: true,
        serverSide: true,
        ajax: {
            url: "@if(Auth::user()->is_admin=='hrd'){{ url('hrd/users_finger_datatable') }}@else{{ url('users_finger-datatable') }}@endif" + '/' + holding,
        },
        columns: [{
                data: "USERID",

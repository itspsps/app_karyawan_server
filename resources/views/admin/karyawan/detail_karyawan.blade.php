                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating form-floating-outline">
                                                    <input style="font-size: small;"
                                                        ...
                                                        value="{{ old('nik', $karyawan->nik) }}" autofocus />
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating form-floating-outline">
                                                    <input style="font-size: small;" class="form-control" type="text"
                                                        id="golongan_darah"
                                                        value="{{ old('golongan_darah', $karyawan->golongan_darah) }}"
    ...
    @enderror
                                        ...
                                        <div class="row mt-2 gy-4">
                                            <div class="col-md-6">
                                                <div class="form-floating form-floating-outline">
                                                    <select style="font-size: small;" class="form-control"
                                                        ...
                                                        <option @if (old('strata_pendidikan', $karyawan->strata_pendidikan) == '') selected @else @endif
                                                            disabled value=""> ~Pilih Tingkatan Pendidikan~ </option>
                                                        <option @if (old('strata_pendidikan', $karyawan->strata_pendidikan) == 'SEKOLAH DASAR (SD)') selected @else @endif
                                                            value="SEKOLAH DASAR (SD)">SEKOLAH DASAR (SD)</option>
                                                        <option @if (old('strata_pendidikan', $karyawan->strata_pendidikan) == 'SEKOLAH MENENGAH PERTAMA (SMP)') selected @else @endif
                                                            value="SEKOLAH MENENGAH PERTAMA (SMP)">SEKOLAH MENENGAH PERTAMA
                                                            (SMP)</option>
                                                        <option @if (old('strata_pendidikan', $karyawan->strata_pendidikan) == 'SEKOLAH MENENGAH AKHIR (SMA)') selected @else @endif
                                                            value="SEKOLAH MENENGAH AKHIR (SMA)">SEKOLAH MENENGAH AKHIR
                                                            (SMA)</option>
                                                        <option @if (old('strata_pendidikan', $karyawan->strata_pendidikan) == 'SEKOLAH MENENGAH KEJURUAN (SMK)') selected @else @endif
                                                            value="SEKOLAH MENENGAH KEJURUAN (SMK)">SEKOLAH MENENGAH
                                                            KEJURUAN (SMK)</option>
                                                        <option @if (old('strata_pendidikan', $karyawan->strata_pendidikan) == 'DIPLOMA I (D1)') selected @else @endif
                                                            value="DIPLOMA I (D1)">DIPLOMA I (D1)</option>
                                                        <option @if (old('strata_pendidikan', $karyawan->strata_pendidikan) == 'DIPLOMA II (D2)') selected @else @endif
                                                            value="DIPLOMA II (D2)">DIPLOMA II (D2)</option>
                                                        <option @if (old('strata_pendidikan', $karyawan->strata_pendidikan) == 'DIPLOMA III (D3)') selected @else @endif
                                                            value="DIPLOMA III (D3)">DIPLOMA III (D3)</option>
                                                        <option @if (old('strata_pendidikan', $karyawan->strata_pendidikan) == 'DIPLOMA IV (D4)') selected @else @endif
                                                            value="DIPLOMA IV (D4)">DIPLOMA IV (D4)</option>
                                                        <option @if (old('strata_pendidikan', $karyawan->strata_pendidikan) == 'SARJANA (S1)') selected @else @endif
                                                            value="SARJANA (S1)">SARJANA (S1)</option>
                                                        <option @if (old('strata_pendidikan', $karyawan->strata_pendidikan) == 'MAGISTER (S2)') selected @else @endif
                                                            value="MAGISTER (S2)">MAGISTER (S2)</option>
                                                        <option @if (old('strata_pendidikan', $karyawan->strata_pendidikan) == 'DOKTOR (S3)') selected @else @endif
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating form-floating-outline">
                                                    <input style="font-size: small;" class="form-control" type="text"
                                                        ...
                                                        value="{{ old('instansi_pendidikan', $karyawan->instansi_pendidikan) }}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating form-floating-outline">
                                                    <input style="font-size: small;" class="form-control" type="text"
                                                        id="jurusan_akademik"
                                                        value="{{ old('jurusan_akademik', $karyawan->jurusan_akademik) }}"
                                            ...
                                            <div id="form_kontrak" class="col-md-6">
                                                <div class="form-floating form-floating-outline">
                                                    <input style="font-size: small;" type="text" class="form-control"
                                                        readonly
                                                        value="@if ($karyawan->kontrak_kerja == 'SP') CV. SUMBER PANGAN @elseif($karyawan->kontrak_kerja == 'SPS') PT. SURYA PANGAN SEMESTA @elseif($karyawan->kontrak_kerja == 'SIP') CV. SURYA INTI PANGAN @endif">
                                    ...
                                    <div class="tab-pane fade" id="nav_alamat" role="tabpanel">
                                        ...
                                        <div id="content_alamat_domisili" class="row mt-2 gy-4">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-floating form-floating-outline">
                                                    <input style="font-size: small;" style="font-size: small;"
                                                        type="number" id="rt_domisili" name="rt_domisili"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-floating form-floating-outline">
                                                    <input style="font-size: small;" style="font-size: small;"
                                                        type="number" id="rw_domisili" name="rw_domisili"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating form-floating-outline">
                                                    <input style="font-size: small;" style="font-size: small;"
                                                        type="text" id="alamat_domisili" name="alamat_domisili"
                                    ...
                                    <div class="tab-pane fade" id="nav_jabatan" role="tabpanel">
                                        <div class="row mt-2 gy-4">
                                            ...
                                            <div id="row_kategori_jabatan" style="margin-top: -1%; margin-left: 2%;"
                                                class="col mb-6">
                                                <label class="form-check-label mb-2" for="kategori_jabatan">Pilih Kategori
                                                    ...
                                                    <div class="row gy-4">
                                                        <div class="col-lg-4 form-check">
                                                            <input style="font-size: small;" type="radio"
                                                                ...
                                                                @if (old('kategori_jabatan', $karyawan->kategori_jabatan) == 'sp') checked @else @endif>
                                                        ...
                                                        <div class="col-lg-4 form-check">
                                                            <input style="font-size: small;" type="radio"
                                                                ...
                                                                @if (old('kategori_jabatan', $karyawan->kategori_jabatan) == 'sps') checked @else @endif>
                                                        ...
                                                        <div class="col-lg-4 form-check">
                                                            <input style="font-size: small;" type="radio"
                                                                ...
                                                                @if (old('kategori_jabatan', $karyawan->kategori_jabatan) == 'sip') checked @else @endif>
                                            ...
                                            <input style="font-size: small;" type="hidden" name="kategori_jabatan"
                                                id="kategori_jabatan"
                                                value="{{ old('kategori_jabatan', $karyawan->kategori_jabatan) }}">
                                        </div>
                                        <div class="row mt-2 gy-4">
                                            <div id="form_departemen" class="col-md-3">
                                                ...
                                                if (old('kategori_jabatan', $karyawan->kategori_jabatan) == null) {
                                                    ...
                                                    } elseif (old('kategori_jabatan', $get_kategori_jabatan) == 'sps' || old('kategori_jabatan', $get_kategori_jabatan) == 'all sps') {
                                                        $kategori_jabatan = 'sps';
                                                        $holding_jabatan = 'PT. SURYA PANGAN SEMESTA';
                                                    } elseif (old('kategori_jabatan', $get_kategori_jabatan) == 'sip' || old('kategori_jabatan', $get_kategori_jabatan) == 'all sip') {
                                                        $kategori_jabatan = 'sip';
                                                        $holding_jabatan = 'CV. SURYA INTI PANGAN';
                                                    } elseif (old('kategori_jabatan', $get_kategori_jabatan) == 'all') {
                                                    ...
                                                    if (old('kategori_jabatan', $karyawan->kategori_jabatan) == 'sp') {
                                                        $holding_jabatan = 'CV. SUMBER PANGAN';
                                                    } elseif (old('kategori_jabatan', $karyawan->kategori_jabatan) == 'sps') {
                                                        $holding_jabatan = 'PT. SURYA PANGAN SEMESTA';
                                                    } elseif (old('kategori_jabatan', $kategori_jabatan) == 'sip') {
                                                        $holding_jabatan = 'CV. SURYA INTI PANGAN';
                                                    } else {
                                                        $holding_jabatan = null;
                                                    }
                                                                        ...
                                                                        <div class="col mb-2">
                                                                            <div
                                                                                ...
                                                                                <select style="font-size: small;"
                                                                                    ...
                                                                                    ?>
                                                                                    <optgroup
                                                                                        label='Daftar Departemen {{ $holding_jabatan }}'>
                                                                        ...
                                                                        <div class="col mb-2">
                                                                            <div
                                                                                ...
                                                                                <select style="font-size: small;"
                                                                                    ...
                                                                                    <optgroup
                                                                                        label='Daftar Divisi {{ $holding_jabatan }}'>
                                                                                        <?php
                                                                                        if (old('kategori_jabatan', $karyawan->kategori_jabatan) == '') {
                                                                                            $kategori_jabatan = $holding;
                                                                                        } else {
                                                                        ...
                                                                        <div class="col mb-2">
                                                                            <div
                                                                                ...
                                                                                <select style="font-size: small;"
                                                                                    ...
                                                                                    <optgroup
                                                                                        label='Daftar Bagian {{ $holding_jabatan }}'>
                                                                                        <?php
                                                                                        if (old('kategori_jabatan', $karyawan->kategori_jabatan) == '') {
                                                                                            $kategori_jabatan = $holding;
                                                                                        } else {
                                                                        ...
                                                                        <div class="col mb-2">
                                                                            <div
                                                                                ...
                                                                                <select style="font-size: small;"
                                                                                    ...
                                                                                    <optgroup
                                                                                        label='Daftar Jabatan {{ $holding_jabatan }}'>
                                                                                        <?php
                                                                                        if (old('kategori_jabatan', $karyawan->kategori_jabatan) == '') {
                                                                                            $kategori_jabatan = $holding;
                                                                                        } else {
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <select style="font-size: small;"
                                                                                    ...
                                                                                    <optgroup
                                                                                        ...
                                                                                        $divisi = App\Models\Divisi::where('dept_id', old('departemen3_id', $karyawan->dept_id))
                                                                                            ->orderBy('nama_divisi', 'ASC')
                                                                                            ->get();
                                                                                        ?>
                                                                                        @foreach ($divisi as $divisi)
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <select style="font-size: small;"
                                                                                    ...
                                                                                    <optgroup
                                                                                        ...
                                                                                        $bagian = App\Models\Bagian::where('divisi_id', old('divisi3_id', $karyawan->divisi3_id))
                                                                                            ->orderBy('nama_bagian', 'ASC')
                                                                                            ->get();
                                                                                        ?>
                                                                                        @foreach ($bagian as $bagian)
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <select style="font-size: small;"
                                                                                    ...
                                                                                    <optgroup
                                                                                        ...
                                                                                        $jabatan = App\Models\Jabatan::where('bagian_id', old('bagian3_id', $karyawan->bagian3_id))
                                                                                            ->orderBy('nama_jabatan', 'ASC')
                                                                                            ->get();
                                                                                        ?>
                                                                                        @foreach ($jabatan as $jabatan)
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <select style="font-size: small;"
                                                                                    ...
                                                                                    <optgroup
                                                                                        ...
                                                                                        $divisi = App\Models\Divisi::where('dept_id', old('departemen4_id', $karyawan->dept_id))
                                                                                            ->orderBy('nama_divisi', 'ASC')
                                                                                            ->get();
                                                                                        ?>
                                                                                        @foreach ($divisi as $divisi)
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <select style="font-size: small;"
                                                                                    ...
                                                                                    <optgroup
                                                                                        ...
                                                                                        $bagian = App\Models\Bagian::where('divisi_id', old('divisi4_id', $karyawan->divisi4_id))
                                                                                            ->orderBy('nama_bagian', 'ASC')
                                                                                            ->get();
                                                                                        ?>
                                                                                        @foreach ($bagian as $bagian)
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <select style="font-size: small;"
                                                                                    ...
                                                                                    <optgroup
                                                                                        ...
                                                                                        $jabatan = App\Models\Jabatan::where('bagian_id', old('bagian4_id', $karyawan->bagian4_id))
                                                                                            ->orderBy('nama_jabatan', 'ASC')
                                                                                            ->get();
                                                                                        ?>
                                                                                        @foreach ($jabatan as $jabatan)
...
@section('js')
    ...
    <script>
        ...
        $('#id_bagian4').on('change', function() {
            ...
            let url =
                "@if (Auth::user()->is_admin == 'hrd'){{ url('hrd/karyawan/get_jabatan') }}@else{{ url('karyawan/get_jabatan') }}@endif";
            $.ajax({
                type: 'GET',
                url: url,
                data: {

                            ...
                            <div class="nav-align-top mb-4">
                                <ul class="nav nav-pills mb-3" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                            data-bs-target="#nav_pendidikan" aria-controls="nav_pendidikan"
                                            aria-selected="false">
                                ...
                                <div class="tab-content">
                                                        ...
                                                        <div class="col-md-12 mb-3">
                                                            <div class="form-floating form-floating-outline">
                                                                <input type="text" name="nama_instansi"
                                                                    id="nama_instansi" class="form-control"
                                                                    value="">
                                                        ...
                                                        <div class="col-md-12 mb-3">
                                                            <div class="form-floating form-floating-outline">
                                                                <input type="text" name="jurusan_update"
                                                                    id="jurusan_update" class="form-control"
                                                                    value="">
                                                    ...
                                                    <div class="form-floating form-floating-outline">
                                                        ...
                                                        @if ($karyawan->ijazah == null)
                                                            <button type="button" id="btn_upload_ijazah"
                                                                class="btn btn-sm"><i
                                                                    class="mdi mdi-upload text-primary"></i> <span
                                                                    class="text-primary">Upload</span></button>
                                                            <label for="file_ijazah">FILE IJAZAH</label>
                                                        @else
                                                            <h5 for="file_ijazah">File Ijazah</h5>
                                                            <input type="hidden" id="file_ijazah_old"
                                                                name="file_ijazah_old" class="form-control"
                                                                value="{{ $karyawan->ijazah }}">
                                                            ...
                                                            <div class="group-button-transkrip_nilai">
                                                                ...
                                                                <button id="btn_change_transkrip_nilai" type="button"
                                                                    class="btn btn-sm bottom-0"><i
                                                                        ...
                                                                        class="text-primary">&nbsp;Ganti</span></button>
                                                                <button type="button"
                                                                    id="btn_delete_file_transkrip_nilai"
                                                                    class="btn btn-sm bottom-0"><i
                                                                        class="mdi mdi-delete text-primary"></i> <span
                                                                        class="text-primary">&nbsp;Hapus</span></button>
                                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="nav_riwayat" role="tabpanel">
                                        ...
                                        <div class="row mt-2 gy-4">
                                            <table class="table table-bordered" id="tabel_riwayat"
                                                style="width: 100%;">
                                                <thead>
                                                    <tr>
                                                        <th>Aksi</th>

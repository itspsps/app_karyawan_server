    ...
    @enderror
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating form-floating-outline">
                                                ...
                                                <img src="{{$karyawan->ktp == NULL ? asset('images/KTP.jpg'):asset('storage/' . $karyawan->ktp) }}" alt="" width="100" height="100">
                                                <button type="button" id="btn_upload_ktp" class="btn btn-primary">Upload</button>
                                            </div>
                                            @error('ktp')
                                            <p class="alert alert-danger">{{ $message }}</p>
                                            @enderror
                                                        ...
                                                        <div class="accordion-body">
                                                            ...
                                                            <div class="row g-2 mt-2">
                                                                <div class="col mb-2">
                                                                    <div class="form-floating form-floating-outline">
                                                                        <select style="font-size: small;"
                                                                            name="departemen3_id" id="id_departemen3"
                                                                            class="form-control">
                                                                            <option value=""> Pilih
                                                                                Departemen</option>
                                                                            <optgroup
                                                            ...
                                                            <div class="row g-2 mt-2">
                                                                <div class="col mb-2">
                                                                    <div class="form-floating form-floating-outline">
                                                                        <select style="font-size: small;"
                                                                            name="departemen4_id" id="id_departemen4"
                                                                            class="form-control">
                                                                            <option value=""> Pilih
                                                                                Departemen</option>
                                                                            <optgroup

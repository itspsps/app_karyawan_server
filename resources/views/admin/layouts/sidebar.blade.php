<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ Request::is('karyawan/tambah-karyawan*') ? 'active open' : '' }}{{ Request::is('karyawan/detail*') ? 'active open' : '' }}{{ Request::is('karyawan/karyawan_masa_tenggang_kontrak/'.$holding) ? 'active open' : '' }} {{ Request::is('karyawan_ingin_bergabung/'.$holding) ? 'active open' : '' }} {{ Request::is('karyawan/'.$holding) ? 'active open' : '' }} {{ Request::is('users*') ? 'active open' : '' }} {{ Request::is('karyawan_non_aktif*') ? 'active open' : '' }}{{ Request::is('detail_jabatan*') ? 'active open' : '' }} {{ Request::is('struktur_organisasi*') ? 'active open' : '' }}{{ Request::is('reset-cuti*') ? 'active open' : '' }}{{ Request::is('departemen*') ? 'active open' : '' }}{{ Request::is('divisi*') ? 'active open' : '' }} {{ Request::is('bagian*') ? 'active open' : '' }} {{ Request::is('jabatan*') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
                <li class="menu-item {{ Request::is('karyawan/tambah-karyawan*') ? 'active open' : '' }}{{ Request::is('karyawan/detail*') ? 'active open' : '' }}{{ Request::is('karyawan/karyawan_masa_tenggang_kontrak/'.$holding) ? 'active open' : '' }} {{ Request::is('karyawan_ingin_bergabung/'.$holding) ? 'active open' : '' }} {{ Request::is('karyawan/'.$holding) ? 'active open' : '' }} {{ Request::is('karyawan/edit-password/*') ? 'active' : '' }} {{ Request::is('users*') ? 'active open' : '' }} {{ Request::is('karyawan_non_aktif*') ? 'active open' : '' }}">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <li class="menu-item {{ Request::is('lokasi-kantor*') ? 'active open' : '' }}{{ Request::is('shift*') ? 'active open' : '' }}{{ Request::is('rekap-data*') ? 'active open' : '' }} {{ Request::is('karyawan/mapping_shift*') ? 'active open' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons mdi mdi-table-account"></i>
                <div style="font-size: 10pt;" data-i18n="Data Master">Absensi&nbsp;Karyawan</div>
            </a>

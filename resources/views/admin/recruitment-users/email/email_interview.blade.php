...
<body>
    <div class="container mt-5">
        <div class="card">
            ...
            <div class="card-body">
                <p>Kepada {{ $user->Cv->nama_depan }} {{ $user->Cv->nama_tengah }} {{ $user->Cv->nama_belakang }},</p>
                ...
                <!-- <p>Harap konfirmasi ketersediaan Anda dengan
                    <a href="{{ url('konfirmasi-interview/'.$user->AuthLogin->email.'/tidak-datang') }}" class="btn rounded-pill btn-info waves-effect waves-light">Tidak Datang</a>
                </p>
                <p>Harap konfirmasi ketersediaan Anda dengan
                    <a href="{{ url('konfirmasi-interview/'.$user->AuthLogin->email.'/datang') }}" class="btn rounded-pill btn-primary waves-effect waves-light">Datang</a>
                </p> -->

    ...
    <div class="row gy-4">
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                                                ...
                                                <div class="card right-profile-card">
                                                    <div class="card-header alert-primary">
                                                        <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                                            <li class="nav-item">
                                                                <a class="nav-link active" id="tabs-profil-tab"
                                                                    data-toggle="pill" href="#tabs-profil"
                                                                    role="tab" aria-selected="true">Profil</a>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a class="nav-link" id="tabs-keterampilan-tab"
                                                                    data-toggle="pill" href="#tabs-keterampilan"
                                                                    role="tab"
                                                                    aria-selected="false">Keterampilan</a>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a class="nav-link" id="tabs-pengalaman-tab"
                                                                    data-toggle="pill" href="#tabs-pengalaman"
                                                                    role="tab"
                                                                    aria-selected="false">Pengalaman</a>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a class="nav-link" id="tabs-prestasi-tab"
                                                                    data-toggle="pill" href="#tabs-prestasi"
                                                                    role="tab" aria-selected="false">Prestasi</a>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a class="nav-link" id="tabs-dokumen-tab"
                                                                    data-toggle="pill" href="#tabs-dokumen"
                                                                    role="tab" aria-selected="false">Dokumen</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="tab-content" id="pills-tabContent">
                                                            <div class="tab-pane fade show active" id="tabs-profil"
                                                                role="tabpanel" aria-labelledby="tabs-profil-tab">
                                                                <div class="row g-2">
                                                                    <div class="col mb-2">
                                                                        <div
                                                                            class="form-floating form-floating-outline">
                                                                            <input type="text"
                                                                                id="show_nama_pelamar2" readonly
                                                                                name="" class="form-control" />
                                                                            <label for="holding_recruitment">NAMA
                                                                                LENGKAP</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row g-2">
                                                                    <div class="col mb-2">
                                                                        <div
                                                                            class="form-floating form-floating-outline">
                                                                            <input type="text"
                                                                                id="show_tempatlahir" readonly
                                                                                name="" class="form-control" />
                                                                            <label for="holding_recruitment">TEMPAT
                                                                                LAHIR</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row g-2">
                                                                    <div class="col mb-2">
                                                                        <div
                                                                            class="form-floating form-floating-outline">
                                                                            <input type="text"
                                                                                id="show_tanggallahir" readonly
                                                                                name="" class="form-control" />
                                                                            <label for="holding_recruitment">TANGGAL
                                                                                LAHIR</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row g-2">
                                                                    <div class="col mb-2">
                                                                        <div
                                                                            class="form-floating form-floating-outline">
                                                                            <input type="text" id="show_gender"
                                                                                readonly name=""
                                                                                class="form-control" />
                                                                            <label for="holding_recruitment">JENIS
                                                                                KELAMIN</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row g-2">
                                                                    <div class="col mb-2">
                                                                        <div
                                                                            class="form-floating form-floating-outline">
                                                                            <input type="text"
                                                                                id="show_statusnikah" readonly
                                                                                name="" class="form-control" />
                                                                            <label for="holding_recruitment">STATUS
                                                                                PERNIKAHAN</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row g-2">
                                                                    <div class="col mb-2">
                                                                        <div
                                                                            class="form-floating form-floating-outline">
                                                                            <input type="text" id="show_nik"
                                                                                readonly name=""
                                                                                class="form-control" />
                                                                            <label
                                                                                for="holding_recruitment">NIK</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="tab-pane fade" id="tabs-keterampilan"
                                                                role="tabpanel">
                                                            ...
                                                            <div class="tab-pane fade" id="tabs-pengalaman"
                                                                role="tabpanel">
                                                                <div class="row">
                                                                        ...
                                                                        <div class="timeline-entry">
                                                                            <div class="timeline-entry-inner">
                                                                                <div class="timeline-icon bg-success">
                                                                                    <span
                                                                                        class="mdi mdi-check-decagram"></span>
                                                                                </div>
                                                                                <div class="timeline-label">
                                                                                    <h2>
                                                                                        <a href="#"
                                                                                            id="show_lokasipengalaman1"></a>
                                                                                        (<span
                                                                                            id="show_tahunpengalaman1"></span>)
                                                                                    </h2>
                                                                        ...
                                                                        <div class="timeline-entry">
                                                                            <div class="timeline-entry-inner">
                                                                                ...
                                                                                <div class="timeline-label">
                                                                                    <h2>
                                                                                        <a href="#"
                                                                                            id="show_lokasipengalaman2"></a>
                                                                                        (<span
                                                                                            id="show_tahunpengalaman2"></span>)
                                                                                    </h2>
                                                                        ...
                                                                        <div class="timeline-entry">
                                                                            <div class="timeline-entry-inner">
                                                                                ...
                                                                                <div class="timeline-label">
                                                                                    <h2>
                                                                                        <a href="#"
                                                                                            id="show_lokasipengalaman3"></a>
                                                                                        (<span
                                                                                            id="show_tahunpengalaman3"></span>)
                                                                                    </h2>
                                                            ...
                                                            <div class="tab-pane fade" id="tabs-prestasi"
                                                                role="tabpanel">
                                                                <div class="row">
                                                                    <div class="timeline-centered">
                                                                        <div class="timeline-entry">
                    ...
                    <form method="post" id="users-form">
                        @csrf
                        <table class="table" id="table_listpelamar" style="width: 100%; font-size: small;">
                    ...
                    <div class="modal fade" id="confirmModalY" data-bs-backdrop="static" tabindex="-1">
                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                            <form method="POST" action="{{ url('/recruitment/lolos-administrasi/' . $holding) }}"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            <div class="form-floating form-floating-outline">
                                                <input type="hidden" value="{{ $id_recruitment }}"
                                                    name="recruitment_admin_id">
                                                <input type="date" id="tanggal_interview" name="tanggal_interview"
                                        ...
                                        <div class="row">
                                            <div class="form-floating form-floating-outline">
                                                <input type="time" id="jam_interview" name="jam_interview"
                                                    class="form-control @error('jam_interview') is-invalid @enderror"
                                                    placeholder="Masukkan Bagian"
                                                    value="{{ old('jam_interview') }}" />
                                        ...
                                        <div class="row">
                                            <div class="form-floating form-floating-outline">
                                                <select
                                                    class="form-control @error('lokasi_interview') is-invalid @enderror"
                                                    id="lokasi_interview" name="lokasi_interview" autofocus
                                                    value="{{ old('lokasi_interview') }}">
                                                    <option value=""> Pilih Lokasi</option>
                                                    <option value="CV. Sumber Pangan (Kediri)">CV. Sumber Pangan
                                                        (KEDIRI)</option>
                                                    <option value="CV. Surya Inti Pangan (Makasar)">CV. Surya Inti
                                                        Pangan (MAKASAR)</option>
                                                    <option value="CV. Surya Pangan Semesta (Kediri)">CV. Surya Pangan
                                                        Semesta (KEDIRI)</option>
                                                    <option value="CV. Surya Pangan Semesta (Ngawi)">CV. Surya Pangan
                                                        Semesta (NGAWI)</option>
                                                    <option value="CV. Surya Pangan Semesta (Subang)">CV. Surya Pangan
                                                        Semesta (SUBANG)</option>
                                                </select>
            ...
            <div class="modal fade" id="confirmModalT" data-bs-backdrop="static" tabindex="-1">
                <div class="modal-dialog modal-dialog-scrollable modal-lg">
                    <form method="POST"
                        action="{{ url('/recruitment/tidak-lolos-administrasi/' . $holding) }}"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="modal-content">
                            <div class="modal-header">
...
<script>
    ...
    $(document).on('click', '#btn_lihat_cv', function() {
        ...
        $('#show_imgktp').attr('src', 'http://192.168.2.2:8000/public/assets/img/dokumen_cv/ijazah/' +
            nama_imgktp);

...
@section('isi')
                                                            ...
                                                            <div class="widget-heading pl-2 pt-2"
                                                                ...
                                                                <div class="">
                                                                    <h6 class="" style="font-weight: bold">Soal No.
                                                                        ...
                                                                        {{-- <span class="badge badge-primary no-soal">{{ $no }}</span> --}}
                                                                    </h6>
                                                                </div>
                                                            </div>
                        ...
                        <div class="card-header bg-white" id="...">
                            <section class="mb-0 mt-0">
                                <div role="menu" class="" data-toggle="collapse"
                                    data-target="#iconAccordionOne" aria-expanded="true" aria-controls="iconAccordionOne"
                                    style="cursor: pointer;">
                                    Nilai User (Klik untuk lihat & tutup)
                                </div>
                            </section>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="widget p-3 shadow">
                                            <div class="widget-heading pl-2 pb-2"
                                                style="border-bottom: 1px solid #e0e6ed;">
                                                Nilai User
                                            </div>
    ...
    {!! session('pesan') !!}
    {{-- @include('admin.recruitment-users.ujian.ew.ew-t-p') --}}
@endsection
@section('js')

    ...
    <div class="modal-dialog modal-sm modal-dialog-scrollable">
        <div class=" modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    <form method="post" action="{{ url('absensi/kehadrian-interview/' . $holding) }}"
                            ...
                            <div class="col mb-2">
                                <div class="form-floating form-floating-outline">
                                    <div class="form-check mt-3">
                                        <input type="hidden" id="show_recruitmentuserid3"
                                            name="show_recruitmentuserid3">
                                        <input type="hidden" id="show_recruitmentinterviewid3"
                                            name="show_recruitmentinterviewid3">
                                        <input name="status_interview" class="form-check-input" type="radio"
                                            value="3" id="defaultRadio2">
                                        <label class="form-check-label" for="defaultRadio1"> HADIR </label>
                                    </div>
                                    <div class="form-check">
                                        <input name="status_interview" class="form-check-input" type="radio"
                                            value="4" id="defaultRadio1">
                        ...
                        <div class="modal-footer">
                            <button type="button" onclick="location.reload();"
                                class="btn btn-sm btn-outline-secondary waves-effect" data-bs-dismiss="modal">
                                Cancel
                            </button>
...
<div class="modal fade" id="modal_ujian" data-bs-backdrop="static" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class=" modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    <form method="post" action="{{ url('ujian/kategori-ujian/' . $holding) }}"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="row g-2">
                            <div class="col mb-2">
                                <div class="form-floating form-floating-outline">
                                    <div class="row">
                                        <div class="col-4">
                                            <input type="hidden" name="id_recruitmentuser"
                                                id="show_recruitmentuserid">
                                            <input type="hidden" name="id_userscareer" id="show_userscareerid">
                                            <div class="form-check">
                                                <input class="form-check-input" name="sd-6" disabled
                                                    type="checkbox" value="6-SD" id="defaultCheck1">
                                                <label class="form-check-label" for="defaultCheck1">
                                                    6-SD
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" name="smp-1" disabled
                                                    type="checkbox" value="SPM-1" id="defaultCheck1">
                                                <label class="form-check-label" for="defaultCheck1">
                                                    SMP-1
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" name="smp-2" disabled
                                                    type="checkbox" value="SMP-2" id="defaultCheck1">
                                                <label class="form-check-label" for="defaultCheck1">
                                                    SMP-2
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" name="smp-3" disabled
                                                    type="checkbox" value="SMP-2" id="defaultCheck1">
                                                <label class="form-check-label" for="defaultCheck1">
                                                    SMP-3
                                                </label>
                                        ...
                                        <div class="col-4">
                                            <div class="form-check">
                                                <input class="form-check-input" name="sma-1" disabled
                                                    type="checkbox" value="SMA-1" id="defaultCheck1">
                                                <label class="form-check-label" for="defaultCheck1">
                                                    SMA-1
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" name="sma-2" disabled
                                                    type="checkbox" value="SMA-2" id="defaultCheck1">
                                                <label class="form-check-label" for="defaultCheck1">
                                                    SMA-2
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" name="sma-3" disabled
                                                    type="checkbox" value="SMA-3" id="defaultCheck1">
                                                <label class="form-check-label" for="defaultCheck1">
                                                    SMA-3
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" name="sbmptn" disabled
                                                    type="checkbox" value="SBMPTN" id="defaultCheck1">
                                                <label class="form-check-label" for="defaultCheck1">
                                                    SBMPTN
                                                </label>
                                            </div>
                                        ...
                                        <div class="col-4">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" name="kelas" disabled
                                                    type="checkbox" value="TOEFL" id="defaultCheck1">
                                                <label class="form-check-label" for="defaultCheck1">
                                                    TOEFL
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" name="kelas" checked
                                                    type="checkbox" value="11" id="defaultCheck1">
                                                <label class="form-check-label" for="defaultCheck1">
                                                    PSIKOTES
                                                </label>
                                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="skill">
                                        ...
                                        <div class=" mb-3">
                                            ...
                                            <span id="show_namasdmi"></span>&nbsp;<br>(<span
                                                id="show_tahunsdmi"></span>)
                                        </div>
                                        <p style="font-weight: bold">SMP/MTS</p>
                                        <div class="mb-3">
                                            <i class="mdi mdi-book-education-outline"></i>
                                            <span id="show_namasmpmts"></span>&nbsp;<br>(<span
                                                id="show_tahunsmpmts"></span>)
                                        </div>
                                        <p style="font-weight: bold">SMA/MA/SMK</p>
                                        <div class=" mb-3">
                                            <i class="mdi mdi-book-education-outline"></i>
                                            <span id="show_namasmamasmk"></span>&nbsp;<br>(<span
                                                id="show_tahunsmamasm"></span>)
                                        </div>
                                        <p style="font-weight: bold">UNIVERSITAS</p>
                                        <div class=" mb-3">
                                            <i class="mdi mdi-book-education-outline"></i>
                                            <span id="show_namauniversitas"></span>&nbsp;<br>(<span
                                                id="show_tahununiversitas"></span>)
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card right-profile-card">
                                <div class="card-header alert-primary">
                                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="tabs-profil-tab" data-toggle="pill"
                                                href="#tabs-profil" role="tab" aria-selected="true">Profil</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="tabs-keterampilan-tab" data-toggle="pill"
                                                href="#tabs-keterampilan" role="tab"
                                                aria-selected="false">Keterampilan</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="tabs-pengalaman-tab" data-toggle="pill"
                                                href="#tabs-pengalaman" role="tab"
                                                aria-selected="false">Pengalaman</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="tabs-prestasi-tab" data-toggle="pill"
                                                href="#tabs-prestasi" role="tab"
                                                aria-selected="false">Prestasi</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="tabs-dokumen-tab" data-toggle="pill"
                                                href="#tabs-dokumen" role="tab" aria-selected="false">Dokumen</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="card-body">
                                    <div class="tab-content" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="tabs-profil" role="tabpanel"
                                            aria-labelledby="tabs-profil-tab">
                                            <div class="row g-2">
                                                <div class="col mb-2">
                                                    <div class="form-floating form-floating-outline">
                                                        <input type="text" id="show_nama_pelamar2" readonly
                                            ...
                                            <div class="row g-2">
                                                <div class="col mb-2">
                                                    <div class="form-floating form-floating-outline">
                                                        <input type="text" id="show_tempatlahir" readonly
                                                            name="" class="form-control" />
                                            ...
                                            <div class="row g-2">
                                                <div class="col mb-2">
                                                    <div class="form-floating form-floating-outline">
                                                        <input type="text" id="show_tanggallahir" readonly
                                                            name="" class="form-control" />
                                            ...
                                            <div class="row g-2">
                                                <div class="col mb-2">
                                                    <div class="form-floating form-floating-outline">
                                                        <input type="text" id="show_gender" readonly
                                                            name="" class="form-control" />
                                            ...
                                            <div class="row g-2">
                                                <div class="col mb-2">
                                                    <div class="form-floating form-floating-outline">
                                                        <input type="text" id="show_statusnikah" readonly
                                                            name="" class="form-control" />
                                            ...
                                            <div class="row g-2">
                                                <div class="col mb-2">
                                                    <div class="form-floating form-floating-outline">
                                                        <input type="text" id="show_nik" readonly name=""
                                                            class="form-control" />
                                        ...
                                        <div class="tab-pane fade" id="tabs-dokumen" role="tabpanel">
                                            <div class="work-container">
                                                <h3 id="">KTP</h3>
                                                <img width="100%" height="100%" src="" id="show_imgktp"
                                                    alt="">
                                            </div>
                                            <div class="work-container">
                                                <h3 id="">KK</h3>
                                                <img width="100%" height="100%" src="" id="show_imgkk"
                                                    alt="">
                                            </div>
                                            <div class="work-container">
                                                <h3 id="">IJAZAH</h3>
                                                <img width="100%" height="100%" src=""
                                                    id="show_imgijazah" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card left-profile-card">
                                <div class="card-body">
                                    ...
                                    <div class="skill">
                                        ...
                                        <div class=" mb-3">
                                            <i class="mdi mdi-book-education-outline"></i>
                                            <span id="show_namasdmi3"></span>&nbsp;<br>(<span
                                                id="show_tahunsdmi3"></span>)
                                        </div>
                                        <p style="font-weight: bold">SMP/MTS</p>
                                        <div class="mb-3">
                                            <i class="mdi mdi-book-education-outline"></i>
                                            <span id="show_namasmpmts3"></span>&nbsp;<br>(<span
                                                id="show_tahunsmpmts3"></span>)
                                        </div>
                                        <p style="font-weight: bold">SMA/MA/SMK</p>
                                        <div class=" mb-3">
                                            <i class="mdi mdi-book-education-outline"></i>
                                            <span id="show_namasmamasmk3"></span>&nbsp;<br>(<span
                                                id="show_tahunsmamasm3"></span>)
                                        </div>
                                        <p style="font-weight: bold">S1/S2/S3</p>
                                        <div class=" mb-3">
                                            <i class="mdi mdi-book-education-outline"></i>
                                            <span id="show_namauniversitas3"></span>&nbsp;<br>(<span
                                                id="show_tahununiversitas3"></span>)
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-8">
                            <div class="card right-profile-card">
                                <div class="card-header alert-primary">
                                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="tabs-satu-tab" data-toggle="pill"
                                                href="#tabs-satu" role="tab" aria-selected="true">Psikotes</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="tabs-dua-tab" data-toggle="pill"
                                                href="#tabs-dua" role="tab" aria-selected="false">Interview
                                                HRD</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="tabs-tiga-tab" data-toggle="pill"
                                                href="#tabs-tiga" role="tab" aria-selected="false">Interview
                                                Manager</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="card-body">
                                    <div class="tab-content" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="tabs-satu" role="tabpanel"
                                            aria-labelledby="tabs-profil-tab">
                                                        ...
                                                        <div class="col mb-2">
                                                            <div class="form-floating form-floating-outline">
                                                                <input type="text" disabled name=""
                                                                    id="show_nama_nilai_ujian_analogi_verbal_antonim"
                                                                    class="form-control" />
                                                                <label for="holding_recruitment">ANALOGI VERBAL
                                                                    (ANTONIM)</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="row g-2">
                                                        <div class="col mb-2">
                                                            <div class="form-floating form-floating-outline">
                                                                <input type="text" disabled name=""
                                                                    id="show_nama_nilai_ujian_analogi_verbal_sinonim"
                                                                    class="form-control" />
                                                                <label for="holding_recruitment">ANALOGI VERBAL
                                                                    (SINONIM)</label>
                                                            </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="row g-2">
                                                        <div class="col mb-2">
                                                            <div class="form-floating form-floating-outline">
                                                                <input type="text" disabled name=""
                                                                    id="show_nama_nilai_ujian_penalaran"
                                                                    class="form-control" />
                                                                <label for="holding_recruitment">PENALARAN ATAU
                                                                    LOGIKA</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="row g-2">
                                                        <div class="col mb-2">
                                                            <div class="form-floating form-floating-outline">
                                                                <input type="text" disabled name=""
                                                                    id="show_nama_nilai_ujian_aritmatika"
                                                                    class="form-control" />
                                            ...
                                            <div class="row g-2">
                                                <div class="col mb-2">
                                                    <div class="form-floating form-floating-outline">
                                                        <input type="text" disabled name=""
                                                            id="show_nama_nilai_total_psikotes"
                                                            class="form-control" />
                                            ...
                                            <!-- <div class="row g-2">
                                                            <div class="col mb-2">
                                                                <div class="form-floating form-floating-outline">
                                                                    <textarea type="text" disabled id="show_catatanujian" name="" class="form-control"
                                        ...
                                        <div class="tab-pane fade" id="tabs-dua" role="tabpanel">
                                            <form method="post"
                                                action="{{ url('/nilai-interview-hrd/update/' . $holding) }}"
                                                enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="row g-2">
                                                            <div class="col mb-2">
                                                                <div class="form-floating form-floating-outline">
                                                                    <input type="hidden"
                                                                        id="show_recruitmentinterviewid1"
                                                                        name="recruitment_interview_id1"
                                                                        class="form-control" />
                                                                    <input id="myRange1" required min="1"
                                                                        max="16" step="1.5" type="range"
                                                                        name="nilai_leadership" class="form-range"
                                                                        value="0" />
                                                                    <button type="button" style="width: 100%; font-size: small;"
                                                                        class="btn btn-outline-primary waves-effect">
                                                                        Nilai Leadership:
                                                                        <span class="badge ms-1"
                                                                            id="show_nilai_leadership"></span>
                                                                    </button>
                                                                </div>
                                                                <br>
                                                                <div class="form-floating form-floating-outline">
                                                                    <textarea type="text" required id="show_catatan_leadership" name="catatan_leadership" class="form-control"
                                                                        style="height: 100px;"></textarea>
                                                                    <label for="holding_recruitment">Catatan
                                                                        Leadership</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="row g-2">
                                                            <div class="col mb-2">
                                                                <div class="form-floating form-floating-outline">
                                                                    <input id="myRange2" require min="1"
                                                                        max="16" step="1.5" type="range"
                                                                        name="nilai_planning" class="form-range"
                                                                        value="0" />
                                                                    <button type="button" style="width: 100%; font-size: small;"
                                                                        class="btn btn-outline-primary waves-effect">
                                                                        Nilai Planning:
                                                                        <span class="badge ms-1"
                                                                            id="show_nilai_planning"></span>
                                                                    </button>
                                                                </div>
                                                                <br>
                                                                <div class="form-floating form-floating-outline">
                                                                    <textarea type="text" required id="show_catatan_planning" name="catatan_planning" class="form-control"
                                                                        style="height: 100px;"></textarea>
                                                                    <label for="holding_recruitment">Catatan
                                                                        Planning</label>
                                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="row g-2">
                                                            <div class="col mb-2">
                                                                <div class="form-floating form-floating-outline">
                                                                    <input id="myRange3" require min="1"
                                                                        max="16" step="1.5" type="range"
                                                                        name="nilai_problemsolving" class="form-range"
                                                                        value="0" />
                                                                    <button type="button" style="width: 100%; font-size: small;"
                                                                        class="btn btn-outline-primary waves-effect">
                                                                        Nilai Problem Solving:
                                                                        <span class="badge ms-1"
                                                                            id="show_nilai_problemsolving"></span>
                                                                    </button>
                                                                </div>
                                                                <br>
                                                                <div class="form-floating form-floating-outline">
                                                                    <textarea type="text" required id="show_catatan_problem_solving" name="catatan_problem_solving"
                                                                        class="form-control" style="height: 100px;"></textarea>
                                                                    <label for="holding_recruitment">Catatan Problem
                                                                        Solving</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="row g-2">
                                                            <div class="col mb-2">
                                                                <div class="form-floating form-floating-outline">
                                                                    <input id="myRange4" require min="1"
                                                                        max="16" step="1.5" type="range"
                                                                        name="nilai_quallity" class="form-range"
                                                                        value="0" />
                                                                    <button type="button" style="width: 100%; font-size: small;"
                                                                        class="btn btn-outline-primary waves-effect">
                                                                        Nilai Quality:
                                                                        <span class="badge ms-1"
                                                                            id="show_nilai_quallity"></span>
                                                                    </button>
                                                                </div>
                                                                <br>
                                                                <div class="form-floating form-floating-outline">
                                                                    <textarea type="text" required id="show_catatan_quality" name="catatan_quality" class="form-control"
                                                                        style="height: 100px;"></textarea>
                                                                    <label for="holding_recruitment">Catatan
                                                                        Quality</label>
                                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="row g-2">
                                                            <div class="col mb-2">
                                                                <div class="form-floating form-floating-outline">
                                                                    <input id="myRange5" require min="1"
                                                                        max="16" step="1.5" type="range"
                                                                        name="nilai_creativity" class="form-range"
                                                                        value="0" />
                                                                    <button type="button" style="width: 100%; font-size: small;"
                                                                        class="btn btn-outline-primary waves-effect">
                                                                        Nilai Creativity:
                                                                        <span class="badge ms-1"
                                                                            id="show_nilai_creativity"></span>
                                                                    </button>
                                                                </div>
                                                                <br>
                                                                <div class="form-floating form-floating-outline">
                                                                    <textarea type="text" required id="show_catatan_creativity" name="catatan_creativity" class="form-control"
                                                                        style="height: 100px;"></textarea>
                                                                    <label for="holding_recruitment">Catatan
                                                                        Creativity</label>
                                                                </div>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="row g-2">
                                                            <div class="col mb-2">
                                                                <div class="form-floating form-floating-outline">
                                                                    <input id="myRange6" require min="1"
                                                                        max="16" step="1.5" type="range"
                                                                        name="nilai_teamwork" class="form-range"
                                                                        value="0" />
                                                                    <button type="button" style="width: 100%; font-size: small;"
                                                                        class="btn btn-outline-primary waves-effect">
                                                                        Nilai Teamwork:
                                                                        <span class="badge ms-1"
                                                                            id="show_nilai_teamwork"></span>
                                                                    </button>
                                                                </div>
                                                                <br>
                                                                <div class="form-floating form-floating-outline">
                                                                    <textarea type="text" required id="show_catatan_teamwork" name="catatan_teamwork" class="form-control"
                                                                        style="height: 100px;"></textarea>
                                                                    <label for="holding_recruitment">Catatan
                                                                        Teamwork</label>
                                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="row g-2">
                                                            <div class="col mb-2">
                                                                <div class="form-floating form-floating-outline">
                                                                    <input id="myRange7" min="1"
                                                                        max="100" step="1.5" type="range"
                                                                        name="nilai_creativity" class="form-range"
                                                                        value="0" />
                                                                    <button type="button"
                                                                        class="btn btn-outline-primary waves-effect d-flex justify-content-between align-items-center"
                                                                        style="width: 100%; font-size: small;">
                                                                        <span>Total Nilai Interview:</span>
                                                                        <span class="badge ms-1"
                                                                            id="show_total_nilai_interview_hrd"></span>
                                                                    </button>
                                                                    <button type="button"
                                                                        class="btn btn-outline-primary waves-effect d-flex justify-content-between align-items-center"
                                                                        style="width: 100%; font-size: small;">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="row g-2">
                                                            <div class="col mb-2">
                                                                <div class="form-floating form-floating-outline">
                                                                    <select id="select_status_interview_manager"
                                                                        name="status_interview_manager" require
                                                                        class="form-select form-select-lg">
                                                                        <option>--Pilih--</option>
                                                                        <option value="1">Ya</option>
                                                                        <option value="2">Tidak</option>
                                                                    </select>
                                                                    <label for="holding_recruitment">Interview
                                                                        Manager</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="tabs-tiga" role="tabpanel">
                                            <form method="post"
                                                action="{{ url('/nilai-interview-manager/update/' . $holding) }}"
                                                enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="row g-2">
                                                    <div class="col mb-2">
                                                        <div class="form-floating form-floating-outline">
                                                            <input type="hidden" id="show_recruitmentinterviewid2"
                                                                name="recruitment_interview_id2"
                                                                class="form-control" />
                                                            <input type="number" required step="0.1"
                                                                id="show_nilaiinterviewmanager"
                                                                name="nilai_interview_manager" class="form-control" />
                                                ...
                                                <div class="row g-2">
                                                    <div class="col mb-2">
                                                        <div class="form-floating form-floating-outline">
                                                            <textarea type="text" required id="show_catataninterviewmanager" name="catatan_interview_manager"
...
<script>
    ...
    $(document).on('click', '#btn_penilaian', function() {
        ...
        if (nama_status_interview === 4 || nama_status_interview === 0) {
            ...
            if (nama_nilai_teamwork != 0 && nama_nilai_creativity != 0 && nama_nilai_quallity !== 0 &&
                nama_nilai_problemsolving != 0 && nama_nilai_planning != 0 && nama_nilai_leadership != 0) {
                $('#myRange7').val(nama_total_nilai_interview_hrd).prop('disabled', true);
                $('#show_total_nilai_interview_hrd').text(nama_total_nilai_interview_hrd);
                $('#myRange7').on('input', function() {
                    $('#show_total_nilai_interview_hrd').text($(this).val());

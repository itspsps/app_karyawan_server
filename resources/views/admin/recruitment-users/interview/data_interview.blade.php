                ...
                <div class="tab-content" id="tab-content">
                    ...
                    <div class="tab-pane" id="icon-tabpanel-1" role="tabpanel" aria-labelledby="icon-tab-1">
                        <div class="table-responsive">
                            <table class="table" id="table_recruitment_interview1" style="width: 100%; font-size: small;">
                                <thead class="table-primary">
                                    <tr>
                                        <th>Tanggal&nbsp;Wawancara</th>
                                        <th>Nama&nbsp;Lengkap</th>
                    ...
                    <div class="tab-pane" id="icon-tabpanel-2" role="tabpanel" aria-labelledby="icon-tab-2">
                        <div class="table-responsive">
                            <table class="table" id="table_recruitment_interview2" style="width: 100%; font-size: small;">
                                <thead class="table-primary">
                                    <tr>
                                        <th>Tanggal&nbsp;Wawancara</th>
                                        <th>Presensi&nbsp;Kehadiran</th>

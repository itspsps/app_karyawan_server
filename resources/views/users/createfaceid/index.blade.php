...
<div class="fixed-content p-0" style=" border-radius: 10px; margin-top: 0%;box-shadow: 0 2px 4px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); ">
    <div class=" container" style="margin-top: -5%;">
        ...
        <div class="col-lg-12">
            <form action="{{ url('home/savefaceid') }}" method="post">
                @csrf
                <div class="notification" style="box-shadow: 0 1px 1px 0 rgba(0, 0, 0, 0.2), 0 3px 10px 0 rgba(0, 0, 0, 0.1);">
                    ...
                    <input type="hidden" id="id_user" name="id_user" value="{{$user_karyawan->id}}">
                </div>
                <div class="text-center" style="margin: 0 auto;">
                    <button class="btn_simpan_face btn btn-sm btn-primary me-2 mb-3" id="btn_klik" type="submit" disabled>
                        <span id="loading" class="spinner-border me-3 spinner-border-sm" role="status" aria-hidden="true"></span>
                        &nbsp; Loading...
                    </button>
                    <!-- <button id="btn_klik" type="submit" class="btn btn-sm btn-primary btn-rounded">
...
<script defer src="{{ asset('assets/assets_users/js/createfaceid.js') }}" onload="onLoadDataDbKaryawan('{{ $karyawan }}')"></script>

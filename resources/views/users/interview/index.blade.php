                    ...
                    <div class="row">
                        ...
                        <h5 class="dz-title">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                id="Layer_1" height="18px" width="18px" viewBox="0 0 512 512" xml:space="preserve">
                                ...
                                <polygon style="fill:#E6EAEA;"
                                    points="111.834,84.273 111.834,474.369 319.602,474.369 400.166,393.805 400.166,84.273 " />
                                <g>
                                    <rect x="111.834" y="84.273" style="fill:#CDD4D5;" width="144.166" height="390.095" />
                                    <polygon style="fill:#CDD4D5;"
                                        points="319.602,393.805 319.602,474.369 400.166,393.805  " />
                                </g>
                                <path style="fill:#FF8C29;"
                                    d="M306.165,50.352C302.127,26.289,281.211,7.95,256,7.95c-25.211,0-46.126,18.339-50.165,42.402  h-34.638v63.602h169.607V50.352H306.165z" />
                                <path style="fill:#F0353D;"
                                    d="M205.835,50.352h-34.638v63.602H256V7.95C230.789,7.95,209.874,26.289,205.835,50.352z" />
                                <circle style="fill:#4ACFD9;" cx="256" cy="253.88" r="93.284" />
                                <path style="fill:#0295AA;"
                                    d="M162.716,253.88c0,51.165,41.194,92.701,92.224,93.27V160.61  C203.911,161.179,162.716,202.715,162.716,253.88z" />
                                <path style="fill:#FFFFFF;"
                                    d="M224.199,299.992c-2.034,0-4.07-0.776-5.621-2.328l-25.441-25.441c-3.105-3.106-3.105-8.139,0-11.244  c3.105-3.104,8.139-3.104,11.243,0l19.82,19.82l68.581-68.581c3.105-3.104,8.139-3.104,11.243,0c3.105,3.106,3.105,8.139,0,11.244  l-74.203,74.203C228.268,299.216,226.233,299.992,224.199,299.992z" />
                                <path
                                ...
                                <path
                                    d="M256,152.646c-55.821,0-101.234,45.413-101.234,101.234S200.179,355.114,256,355.114s101.234-45.413,101.234-101.234  S311.821,152.646,256,152.646z M256,339.213c-47.053,0-85.333-38.28-85.333-85.333s38.28-85.333,85.333-85.333  s85.333,38.28,85.333,85.333S303.053,339.213,256,339.213z" />
                            </svg>
                            Daftar Interview
                        </h5>
                    </div>
                ...
                <div class="card" style="margin-top: 0%;">
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <button class="nav-link active" id="nav-izin-tab" data-bs-toggle="tab"
                                data-bs-target="#nav-izin" type="button" role="tab" aria-controls="nav-izin"
                                aria-selected="true">Hari Ini</button>
                            <button class="nav-link" id="nav-cuti-tab" data-bs-toggle="tab" data-bs-target="#nav-cuti"
                                type="button" role="tab" aria-controls="nav-cuti"
                                aria-selected="false">History</button>
                        </div>
                    </nav>
                    <div class="tab-content" id="nav-tabContent" style="margin-top: 2%;">
                        <div class="tab-pane fade show active" id="nav-izin" role="tabpanel"
                            aria-labelledby="nav-izin-tab">
                            @if ($table->count() > 0)
                                @foreach ($table as $table)
                                    <a id="btn_klik" href="{{ url('/interview/detail/' . $table->id) }}">
                                        <div class="swiper-slide">
                                            <div class="card job-post"
                                                style="box-shadow: 0 1px 1px 0 rgba(0, 0, 0, 0.2), 0 3px 10px 0 rgba(0, 0, 0, 0.1); margin-bottom: 4%;">
                                                <div class="card-body" style="padding: 6px;">
                                                    <div class="media media-70">
                                                        @if ($table->User != '')
                                                            @if ($table->User->foto_karyawan != '')
                                                                <img src="{{ asset('../storage/app/public/foto_karyawan/' . $table->User->foto_karyawan) }}"
                                                                    alt="/">
                                                            @else
                                                    ...
                                                    <div class="card-info">
                                                        <h6 class="title" style="font-size: 9pt;">
                                                            {{ $table->Cv->nama_lengkap }}</h6>
                                                        <span
                                                            class="location">{{ $table->Jabatan->nama_jabatan }}({{ $table->Jabatan->Bagian->Divisi->Departemen->nama_departemen }})</span>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <span style="font-size: 9pt;"
                                                                class="ms-2 price-item">{{ \Carbon\Carbon::parse($table->tanggal_interview_manager)->format('d-m-Y') }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

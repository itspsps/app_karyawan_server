	...
	<div class="sidebar">
		<div class="author-box">
			<div class="dz-media">
				<img src="{{ asset('assets/assets_users/images/author/pic1.png') }}" class="rounded-circle" alt="author-image">
			</div>
			<div class="dz-info">
				<span>Good Night</span>
				<h5 class="name">Faesol</h5>
			</div>
		</div>
		<ul class="nav navbar-nav">
			...
			<li>
				<a class="nav-link" id="btn_klik" href="pages.html">
			...
			<li><a class="nav-link" id="btn_klik" href="ui-components.html">
			...
			<li>
				<a class="nav-link" id="btn_klik" href="notification.html">

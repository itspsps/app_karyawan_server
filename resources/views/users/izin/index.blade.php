...
<div class="head-details">
    <div class="container">
        <div class="row">
            ...
            <div class="dz-info col-4">
                <div class="dz-media media-40">
                        ...
                        $.each(data, function(count) {
                            $('.content-history').append(function() {
                                ...
                                if (data[count].status_izin == 0 || data[count].status_izin == 'NOT APPROVE') {
                                    ...
                                    var notif5 = notif1 + notif2 + notif3 + notif4 + "<a href='javascrpit:void(0);' class='btn btn-sm light btn-primary ms-2' data-bs-dismiss='offcanvas' aria-label='Close'>Batal</a></div></div>";
                                    // return notif5;

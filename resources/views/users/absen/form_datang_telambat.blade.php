                ...
                <form class="my-2" method="post" action="{{ url('/izin/tambah-izin-proses/') }}" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div id="form_jam_pulang_cepat" class="input-group">
                            ...
                            <input type="time" name="jam_pulang_cepat" id="jam_pulang_cepat" value="@if($jam_kerja=='') @else {{ \Carbon\Carbon::parse($jam_kerja->Shift->jam_keluar)->addHour(-3)->format('H:i')}} @endif" min="" style="font-weight: bold" placeholder="Jam Pulang" class="form-control">
                        </div>

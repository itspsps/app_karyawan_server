                    ...
                    <div class="card-body">
                        <div class="skill-section">
                            <div class="row">
                                <div class="col-12">
                                    <div class="skill-bar">
                                        <iframe id="lihat_file_cv" src="{{url('https://hrd.sumberpangan.store:4430/storage/app/public/file_cv/'.$user_karyawan->file_cv)}}" style=" height: 500px; width: 100%;"></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>

        ...
        <div class="banner-wrapper author-notification">
            <div class="container inner-wrapper">
                ...
                <div class="dz-media media-50 rounded-circle">
                    ...
                    @else
                    <a href="{{route('profile')}}"><img src="{{ url('https://hrd.sumberpangan.store:4430/storage/app/public/foto_karyawan/'.$user_karyawan->foto_karyawan) }}" class="rounded-circle" alt="author-image"></a>
                    @endif
                </div>
            </div>
        </div>

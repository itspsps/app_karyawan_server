...
<div class="offcanvas offcanvas-bottom" data-bs-keyboard="false" tabindex="-1" data-bs-backdrop="true" id="off-canvas-all-menu" aria-labelledby="offcanvasBottomLabel">
    ...
    <div class="offcanvas-body text-center small scrollable-menu">
        ...
        <ul class="d-flex align-items-center">
            ...
            @endif
            @if(Auth::user()->access_3 == 'on')
            <li class="text-center">
                <a class="nav-link " id="btn_klik" href="{{ url('/interview/dashboard/') }}">
                    <span class="dz-icon bg-blue light" style="height: 50px; width: 50px; box-shadow: 0 1px 1px 0 rgba(0, 0, 0, 0.2), 0 3px 10px 0 rgba(0, 0, 0, 0.1);">
                        <span id="notif_interview" class="badge badge-danger light" style="position: absolute; margin-top: -12%; margin-right: -12%; "></span>
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" viewBox="0 0 512 512" xml:space="preserve">
                            <rect x="77.913" y="50.352" style="fill:#365558;" width="178.087" height="453.698" />
                            <rect x="256" y="50.352" style="fill:#687F82;" width="178.087" height="453.698" />
                            <polygon style="fill:#E6EAEA;" points="111.834,84.273 111.834,474.369 319.602,474.369 400.166,393.805 400.166,84.273 " />
